...
import { int, mysqlTable, text, varchar,timestamp, mysqlEnum, year, datetime, serial, bigint } from 'drizzle-orm/mysql-core';
...
export const employers = mysqlTable("employers",{
  ...
  yearOfEstablisment:year("year_of_establisment"),
