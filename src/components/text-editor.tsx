...
import { BoldIcon, Code2Icon, HighlighterIcon, ItalicIcon, LinkIcon, ListIcon, ListOrderedIcon, PilcrowIcon, QuoteIcon, RedoIcon, StrikethroughIcon, UnderlineIcon, UndoIcon, Unlink2Icon } from 'lucide-react'
...
const ToolBar = ({ editor } : {editor : Editor}) => {
    ...
    return (
        ...
        >
            ...
            <div className="bg-border mx-1 h-6 w-px inline-flex" />
            {editorState.isLink ? (
                <Toggle 
                ...
                >
                    <Unlink2Icon className='h4 w-4'/>
                </Toggle>
             ):(
                <LinkComponent editor={editor}>
                    <Toggle size="sm" arial-label="toggle link">
